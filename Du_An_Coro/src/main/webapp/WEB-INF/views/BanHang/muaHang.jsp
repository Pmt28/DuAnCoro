...
<%--&lt;%&ndash;                                <input type="text" id="maHD" name="maHD" value="${maHD}">&ndash;%&gt;--%>
                        ...
                        <div class="list_duLieu">
                            <div class="sanPhamChiTiet">
                                <div class="col-12">
                                    ...
                                    <div class="scrollable-list" style="width: 500px">
                                        <table class="data-table" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <th class="table-header"
                                                    style="text-align: center; color: black">Trạng
                                                    thái</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <div>
                                        <h5 style="color: black; margin-left: 340px; margin-top: 30px">
                                            Tổng: ${tong} VND</h5>
                                    </div>
                                </div>
                            </div>
