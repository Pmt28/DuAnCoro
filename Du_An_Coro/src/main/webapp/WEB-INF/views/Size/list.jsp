    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div>
                ...
                <h1 style="text-align: center; color: black; margin-top: 50px; margin-bottom: 50px">List danh sách Size</h1>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th scope="col" style="text-align: center">Mã size</th>
                    ...
                    <tbody>
                    <c:forEach var="sz" items="${sizelist}" varStatus="i">
                        <tr>
                            <th style="padding-top: 40px" scope="row">${i.index+1}</th>
                            <td style="padding-top: 55px; text-align: center">${sz.maSize}</td>
                            <td style="padding-top: 55px; text-align: center">${sz.size}</td>
                            <td style="padding-top: 55px; text-align: center">${sz.soLuong}</td>
                            <td style="padding-top: 55px; text-align: center">${sz.ngayTao}</td>
                            <td style="padding-top: 55px; text-align: center">${sz.ngaySua}</td>
                            <td style="padding-top: 55px; text-align: center">${sz.trangThai==1?"Còn hàng" : "Hết hàng"}</td>
                            <td>
